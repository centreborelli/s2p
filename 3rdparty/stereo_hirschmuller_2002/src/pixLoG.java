...
public class pixLoG {
	 ...
	 */
	public static ImageUInt8 denseDisparity( ImageFloat32 rectLeft , ImageFloat32 rectRight ,
                                  ...
                                  int regionRadiusX, int regionRadiusY, double maxPerPixelError, int validateRtoL, double texture)
	{
      ...
      // int validateRtoL, double texture, java.lang.Class<T> imageType) 
		StereoDisparity<ImageFloat32,ImageUInt8> disparityAlg =
...
//		rectify(distLeft,distRight,param,rectLeft,rectRight);
      ...
      distRightF = LoG(distRightF);
		...
		// compute disparity
		ImageUInt8 disparity = denseDisparity(distLeftF,distRightF,mindisp,maxdisp,regionRadius,regionRadius,maxPerPixelError,validateRtoL,texture);
