...
public class subpix {
	 ...
	 */
	public static ImageFloat32 denseDisparity( ImageUInt8 rectLeft , ImageUInt8 rectRight ,
...
//		rectify(distLeft,distRight,param,rectLeft,rectRight);
		...
		// compute disparity
		ImageFloat32 disparity = denseDisparity(distLeft,distRight,mindisp,maxdisp,regionRadius,regionRadius,maxPerPixelError,validateRtoL,texture);
