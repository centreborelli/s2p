...
def image_crop_and_apply_homography(im_out, im_in, H, w, h):
    """
    Warps a piece of a Pleiades image with a homography.
    ...
    output image corresponds to coord_out in [0, w] x [0, h].
    """
    ...
    # are aliased
    # TODO: this is not needed for color images, isn't it ?
