...
def test_rectification_homographies(matches):
    ...
    H1, H2, F = s2p_aidash.rectification.rectification_homographies(matches, x, y, w, h)
...
def test_rectify_pair_no_matches(tmp_path, images):
    ...
    with pytest.raises(s2p_aidash.rectification.NoRectificationMatchesError):
        s2p_aidash.rectification.rectify_pair(
            im1=im1,
            im2=im2,
            rpc1=rpc1,
            rpc2=rpc2,
